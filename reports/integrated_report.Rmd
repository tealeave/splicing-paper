...
for (file in summary_files) {
  ...
  splicing_summaries[[comparison]] <- read.csv(file)
}

# Combine all summaries
all_summaries <- bind_rows(lapply(names(splicing_summaries), function(comp) {
  cbind(Comparison = comp, splicing_summaries[[comp]])
}))
